...
class BiPiperConfig(RobotConfig):
    """
    Configuration class for the BiPiper robot.

    Attributes:
        port_left: Can port for the left arm.
        port_right: Can port for the right arm.
...
class BiPiperEndEffectorConfig(BiPiperConfig):
    """
    Configuration class for the end effector of the BiPiper robot.
